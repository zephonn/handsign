...
if selected_index=='Home':
    st.markdown(
        "<div style='background-color: #333333;border: 3px solid #219C90; border-radius:100px;'><h1 style='text-align:center;color:white;'>Hand Sign Image Prediction</h1></div",
...
if selected_index=='Test Model':
    ...
    o = None
    raa = st.selectbox(label='select any file from my testing folder', options=g)
